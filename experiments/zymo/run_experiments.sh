...
/usr/bin/time -o ${output_dir}/log/SRR13128014_kvmer_sketch.time -v ${kvmer_dir} sketch ./data/zymo/SRR13128014.fastq -o ${output_dir}/SRR13128014.kvmer  2> ${output_dir}/log/SRR13128014_kvmer_sketch.log
...
/usr/bin/time -o ${output_dir}/log/SRR13128014_kvmer_sketch_bi.time -v ${kvmer_dir} sketch --bidirectional ./data/zymo/SRR13128014.fastq -o ${output_dir}/SRR13128014_bi.kvmer  2> ${output_dir}/log/SRR13128014_kvmer_sketch_bi.log
