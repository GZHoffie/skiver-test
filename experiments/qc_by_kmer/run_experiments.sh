...
/usr/bin/time -o ${output_dir}/log/ERR2935851_combined_genomescope.time -v ./tools/run_genomescope.sh ./data/zymo/ERR2935851_combined.fastq.gz ${output_dir} ERR2935851_combined_genomescope &> ${output_dir}/log/ERR2935851_combined_genomescope.log
...
/usr/bin/time -o ${output_dir}/log/SRR13128014_genomescope.time -v ./tools/run_genomescope.sh ./data/zymo/SRR13128014.fastq ${output_dir} SRR13128014_genomescope &> ${output_dir}/log/SRR13128014_genomescope.log
