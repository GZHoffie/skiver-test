...
/usr/bin/time -o ${output_dir}/log/HG002_kvmer_analyze.time -v ${kvmer_dir} analyze -k 31 -v 13 --outlier-threshold 1.5 ${output_dir}/HG002.kvmer -o ${output_dir}/HG002_kvmer_verbose.csv --hazard-ratio ${output_dir}/HG002_kvmer_hazard_ratio.csv 2> ${output_dir}/log/HG002_kvmer_analyze.log > ${output_dir}/HG002_kvmer.csv
/usr/bin/time -o ${output_dir}/log/HG002_R941_kvmer.time -v ${kvmer_dir} analyze -k 31 -v 13 --outlier-threshold 1.5 ${output_dir}/HG002_R941.kvmer -o ${output_dir}/HG002_R941_kvmer_verbose.csv --hazard-ratio ${output_dir}/HG002_R941_kvmer_hazard_ratio.csv 2> ${output_dir}/log/HG002_R941_kvmer_analyze.log > ${output_dir}/HG002_R941_kvmer.csv
/usr/bin/time -o ${output_dir}/log/HG002_hifi_kvmer.time -v ${kvmer_dir} analyze -k 31 -v 13 --outlier-threshold 1.5 ${output_dir}/HG002_hifi.kvmer -o ${output_dir}/HG002_hifi_kvmer_verbose.csv --hazard-ratio ${output_dir}/HG002_hifi_kvmer_hazard_ratio.csv 2> ${output_dir}/log/HG002_hifi_kvmer_analyze.log > ${output_dir}/HG002_hifi_kvmer.csv
