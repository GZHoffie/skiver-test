# Tests for Skiver algorithm

- [data](./data/) folder contains guide to download the datasets used in the experiments, as well as scripts for generating simulated data.
