chmod +x ./data/download_from_accession.sh
...
# Zymo Log Mock Community, Nanopore GridION reads
...
# Download B. subtilis, Illumina reads
...
cd ../..
# Download B. subtilis, PacBio RSII reads
prefetch SRR7498042
fasterq-dump SRR7498042 --split-files -O ./data/zymo/

# Download Zymo Gut Microbiome, PacBio Hifi reads
...
# Download Human, Nanopore R10.4 reads
...
# Download Human, PacBio Hifi reads
